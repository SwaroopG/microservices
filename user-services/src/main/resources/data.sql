...
insert into user(id,firstname,lastname,email) values(4, 'First 4', 'Last 4', '4@email.com');
insert into user(id,firstname,lastname,email) values(5, 'First 5', 'Last 5', '5@email.com');
insert into user(id,firstname,lastname,email) values(6, 'First 6', 'Last 6', '6@email.com');